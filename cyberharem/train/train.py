...
_DEFAULT_TRAIN_CFG = 'cfgs/train/examples/lora_anime_character_reg_v1.5.yaml'
...
def train_plora(ds_repo_id: str, dataset_name: str = 'stage3-p480-800',
    ...
    with load_dataset_from_repository(ds_repo_id, dataset_name) as dataset_dir, \
        ...
        with TemporaryDirectory() as embs_dir:
            ...
            conf = load_config_with_cli(_DEFAULT_TRAIN_CFG, args_list=cli_args)  # skip --cfg

            logging.info(f'Training with {_DEFAULT_TRAIN_CFG!r}, args: {cli_args!r} ...')
            if single_card:
